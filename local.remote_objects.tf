locals {
  remote_objects = {
    ...
    app_services_linux                             = try(local.combined_objects_app_services_linux, null)
    # app_services_windows                           = try(local.combined_objects_app_services_windows, null)
    ...
    cost_anomaly_alerts                            = try(local.combined_objects_cost_anomaly_alerts, null)
